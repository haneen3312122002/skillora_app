...
final uploadCoverImageViewModelProvider =
    AsyncNotifierProvider<UploadCoverImageViewModel, String?>(
  UploadCoverImageViewModel.new,
);

class UploadCoverImageViewModel extends AsyncNotifier<String?> {
  @override
  ...
  Future<void> submit(
    ...
    try {
      ...
      final url = await svc.uploadCoverImage(bytes);
      state = AsyncData(url);
      _snack(context, 'Cover image updated');
    } catch (e, st) {
